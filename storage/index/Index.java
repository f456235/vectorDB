...
public abstract class Index {
	...
	public static Index newInstance(IndexInfo ii, SearchKeyType keyType, Transaction tx) {
		...
		// 	return new LSHashIndex(ii, keyType, tx);
			...
			return new IVF_FLATIndex(ii, keyType, tx);
		else
			throw new IllegalArgumentException("unsupported index type");
	}
	...
	public abstract void beforeFirst(DistanceFn distFn);
	...
	public abstract void insert(VectorConstant key, RecordId dataRecordId);
