...
public class IndexInfo {
	...
	// 黎
	// 新增 IVF_FLATIndex 專用的 open 方法
    /*public IVF_FLATIndex openIVF(Transaction tx, int K) {
        TableInfo ti = VanillaDb.catalogMgr().getTableInfo(tblName, tx);
        if (ti == null)
            throw new TableNotFoundException("table '" + tblName + "' is not defined in catalog.");
        return new IVF_FLATIndex(tx, this, K);
    }*/
