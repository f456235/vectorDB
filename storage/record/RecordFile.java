...
public class RecordFile implements Record {
	...
	public boolean next() {
		...
		if (currentBlkNum == 0 && !moveTo(1)){
			System.out.println("only metadata block exists, no data records");
			return false;
		}
	...
	public void moveToRecordId(RecordId rid) {
		...
		// System.out.println("Moving to record ID: " + rid);
		// System.out.println("Current block number: " + currentBlkNum);
